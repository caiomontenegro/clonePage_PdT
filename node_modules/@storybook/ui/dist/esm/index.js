...
shortcutKeys:toShortcutState(props.shortcutKeys),addonsShortcutLabels:props.addonsShortcutLabels};return _this13;}_createClass2(ShortcutsScreen,[{key:"render",value:function render(){var layout=this.renderKeyForm();return React$2.createElement(Container$1,null,React$2.createElement(Header,null,"Keyboard shortcuts"),layout,React$2.createElement(Button,{tertiary:true,small:true,id:"restoreDefaultsHotkeys",onClick:this.restoreDefaults},"Restore defaults"),React$2.createElement(SettingsFooter,null));}}]);return ShortcutsScreen;}(Component);var ShortcutsPage=function ShortcutsPage(){return React$2.createElement(Consumer,null,function(_ref225){var _ref225$api=_ref225.api,getShortcutKeys=_ref225$api.getShortcutKeys,getAddonsShortcutLabels=_ref225$api.getAddonsShortcutLabels,setShortcut=_ref225$api.setShortcut,restoreDefaultShortcut=_ref225$api.restoreDefaultShortcut,restoreAllDefaultShortcuts=_ref225$api.restoreAllDefaultShortcuts;return React$2.createElement(ShortcutsScreen,Object.assign({shortcutKeys:getShortcutKeys(),addonsShortcutLabels:getAddonsShortcutLabels()},{setShortcut:setShortcut,restoreDefaultShortcut:restoreDefaultShortcut,restoreAllDefaultShortcuts:restoreAllDefaultShortcuts}));});};var document$1=window_1.document;var TabBarButton=React$2.memo(function(_ref226){var changeTab=_ref226.changeTab,id=_ref226.id,title=_ref226.title;return React$2.createElement(Location,null,function(_ref227){var path=_ref227.path;var active=path.includes("settings/".concat(id));return React$2.createElement(TabButton,{id:"tabbutton-".concat(id),className:['tabbutton'].concat(active?['tabbutton-active']:[]).join(' '),type:"button",key:"id",active:active,onClick:function onClick(){return changeTab(id);},role:"tab"},title);});});var Content=styled(ScrollArea)({position:'absolute',top:40,left:0,right:0,bottom:0,overflow:'auto'},function(_ref228){var theme=_ref228.theme;return{background:theme.background.content};});var Pages=function Pages(_ref229){var changeTab=_ref229.changeTab,onClose=_ref229.onClose,_ref229$enableShortcu=_ref229.enableShortcuts,enableShortcuts=_ref229$enableShortcu===void 0?true:_ref229$enableShortcu,_ref229$hasReleaseNot=_ref229.hasReleaseNotes,hasReleaseNotes=_ref229$hasReleaseNot===void 0?false:_ref229$hasReleaseNot;React$2.useEffect(function(){var handleEscape=function handleEscape(event){if(!enableShortcuts||event.repeat)return;if(matchesModifiers(false,event)&&matchesKeyCode('Escape',event)){event.preventDefault();onClose();}};document$1.addEventListener('keydown',handleEscape);return function(){return document$1.removeEventListener('keydown',handleEscape);};},[]);return React$2.createElement(Fragment,null,React$2.createElement(FlexBar,{border:true},React$2.createElement(TabBar,{role:"tablist"},React$2.createElement(TabBarButton,{id:"about",title:"About",changeTab:changeTab}),hasReleaseNotes&&React$2.createElement(TabBarButton,{id:"release-notes",title:"Release notes",changeTab:changeTab}),React$2.createElement(TabBarButton,{id:"shortcuts",title:"Keyboard shortcuts",changeTab:changeTab})),React$2.createElement(IconButton,{onClick:function onClick(e){e.preventDefault();return onClose();},title:"Close settings page"},React$2.createElement(Icons,{icon:"close"}))),React$2.createElement(Content,{vertical:true,horizontal:false},React$2.createElement(Route,{path:"about"},React$2.createElement(AboutPage,{key:"about"})),React$2.createElement(Route,{path:"release-notes"},React$2.createElement(ReleaseNotesPage,{key:"release-notes"})),React$2.createElement(Route,{path:"shortcuts"},React$2.createElement(ShortcutsPage,{key:"shortcuts"}))));};var SettingsPages=function SettingsPages(){var api=useStorybookApi();var state=useStorybookState();var changeTab=function changeTab(tab){return api.changeSettingsTab(tab);};return React$2.createElement(Pages,{hasReleaseNotes:!!api.releaseNotesVersion(),enableShortcuts:state.ui.enableShortcuts,changeTab:changeTab,onClose:api.closeSettings});};var View=styled.div({position:'fixed',overflow:'hidden',height:'100vh',width:'100vw'});var App=React$2.memo(function(_ref230){var viewMode=_ref230.viewMode,docsOnly=_ref230.docsOnly,layout=_ref230.layout,panelCount=_ref230.panelCount,_ref230$size=_ref230.size,width=_ref230$size.width,height=_ref230$size.height;var content;var props=useMemo(function(){return{Sidebar:Sidebar,Preview:PreviewConnected,Panel:Panel,Notifications:NotificationConnect,pages:[{key:'settings',render:function render(){return React$2.createElement(SettingsPages,null);},route:function route(_ref231){var children=_ref231.children;return React$2.createElement(Route,{path:"/settings/",startsWith:true},children);}}]};},[]);if(!width||!height){content=React$2.createElement("div",null);}else if(width<600){content=React$2.createElement(Mobile,Object.assign({},props,{viewMode:viewMode,options:layout,docsOnly:docsOnly}));}else{content=React$2.createElement(Desktop,Object.assign({},props,{viewMode:viewMode,options:layout,docsOnly:docsOnly},{width:width,height:height},{panelCount:panelCount}));}return React$2.createElement(View,null,React$2.createElement(Global,{styles:createGlobal}),React$2.createElement(Symbols,{icons:['folder','component','document','bookmarkhollow']}),content);},// This is the default shallowEqual implementation, but with custom behavior for the `size` prop.
